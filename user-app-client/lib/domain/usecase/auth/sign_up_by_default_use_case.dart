...
class SignUpByDefaultUseCase extends BaseUseCase
    implements AsyncConditionUseCase<void, SignUpByDefaultCondition> {
  ...
  @override
  Future<StateWrapper> execute(SignUpByDefaultCondition condition) async {
    StateWrapper<Map<String, dynamic>> state =
        await _authRepository.signUpByDefault(condition);
